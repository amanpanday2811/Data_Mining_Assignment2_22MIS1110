...
1039 34 Male Employed 380000 Yes 710
1040 30 Male Unemployed 0 No 580
", header = TRUE)

# Select relevant columns for clustering
clustering_data <- data[, c("Monthly_Balance_INR", "Credit_Score")]

# Run DBSCAN clustering
dbscan_result <- dbscan(clustering_data, eps = 50000, minPts = 5)

# Print cluster membership
print(dbscan_result$cluster)

# Plot clusters
plot(clustering_data, col = dbscan_result$cluster + 1, pch = 19, main = "DBSCAN Clustering")
